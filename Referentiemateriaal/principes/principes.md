...
**Status:** Voorstel
**Datum:** 2026-04-09
**Consolidatie:** Zie [ADR 0006](https://github.com/Npuls-OKx/meta/blob/cf9d62a84d06dca0f6818cce01250e70d319f549/architecture/dr/0006-consolidatie-architectuurprincipes.md) voor de afwegingen en besluiten achter deze principes.

Dit document beschrijft de **architectuurprincipes** (AP01–AP13) voor uitwerkingen in deze knowledge base. Principes zijn abstracte, stabiele richtlijnen die niet snel wijzigen — ze beschrijven *waarom* we dingen op een bepaalde manier doen. Het is geen vervanging van concrete ADR's; bij twijfel of uitzondering leg je een besluit vast in `architecture/dr/`.

Naast principes hanteert OKx **[uitgangspunten](uitgangspunten.md)**: gefundeerde besluiten om blocking issues te voorkomen. Uitgangspunten zijn concreter, kunnen evolueren, en beschrijven *wat* we aannemen en *hoe* we werken. Zie [OKx-uitgangspunten](uitgangspunten.md) voor het volledige overzicht.

Beide worden gevoed door de [MOSA-visie op sectorvoorzieningen](https://github.com/Npuls-OKx/meta/blob/cf9d62a84d06dca0f6818cce01250e70d319f549/architecture/docs/principes/doc/MOSA-Visiedocument.md), de [MOSA vs OKx analyse](https://github.com/Npuls-OKx/meta/blob/cf9d62a84d06dca0f6818cce01250e70d319f549/architecture/docs/principes/doc/MOSA_vs_OKx_analyse.md), en de praktijkervaring van het OKx-kernteam.

### Gerelateerde documenten

- [OKx-uitgangspunten](uitgangspunten.md) — gefundeerde besluiten voor specificatie en bouw
