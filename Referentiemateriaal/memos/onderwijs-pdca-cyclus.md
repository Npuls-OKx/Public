...
**Herkomst.** Deze analyse is ingebracht door Niels en beschrijft hoe een instelling haar onderwijs cyclisch herziet, en wat dat betekent voor het wijzigen van onderwijsspecificaties. Ze is niet in dit repository ontstaan maar overgenomen uit de meta-repository; de tekst staat hier ongewijzigd.

**Waarvoor ze dient.** De analyse is de invoer voor twee documenten in het releasepakket: de [lifecycle en versionering van onderwijsspecificaties](../../Koppelvlakspecificaties/Koppelingspecificaties/gedeeld/lifecycle-en-versionering.md), die de versioneringsmechaniek vastlegt, en de [resultaatstructuur en het examenplan](../../Koppelvlakspecificaties/Koppelingspecificaties/oc-sis-krs-svs/resultaatstructuur-en-examenplan.md), dat de zwaarste acceptatieregels draagt omdat het examenplan een contractuele afspraak met de student is. Waar die documenten spreken over acceptatieregels of over het scheiden van identiteit en versie, komt de redenering hiervandaan.
