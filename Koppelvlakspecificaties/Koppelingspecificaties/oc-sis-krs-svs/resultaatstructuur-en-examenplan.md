...
Eén verschil: de `examenplanspecificatie` heeft de **strengste acceptatieregels**. Het is een contractuele afspraak met de student, dus een wijziging vraagt altijd expliciete impactanalyse en besluitvorming, ook wanneer die technisch niet-brekend lijkt ([memo van Niels](../../../Referentiemateriaal/memos/onderwijs-pdca-cyclus.md)).
...
- Onderwijsspecificatie: [onderwijsspecificatie-payload](../gedeeld/payload-onderwijsspecificatie.md).
- Lifecycle: [lifecycle en versionering](../gedeeld/lifecycle-en-versionering.md).
- Memo "Onderwijs PDCA-cyclus" van Niels: `doc/OKx_PDCA cyclus onderwijsontwerp.md`.
- [OKE-koppelvlak voor uitvoering en beoordeling](https://github.com/Npuls-OKx/meta/blob/d47bb0c74ec899a4384d06331692f74b9bd1db58/OKE/moka-koppelvlakspecificaties/Examen%20Uitvoering%20en%20beoordeling/doc/KoppelvlakSpecificatieDocument.md): het examendomein waar dit document buiten blijft.
- [ADR 0009](../../../Referentiemateriaal/adr/0009-sks-svs-rollenverdeling-keuze-vs-resultaat-voortgang.md) (SKS/SVS: keuze versus resultaat en voortgang).
