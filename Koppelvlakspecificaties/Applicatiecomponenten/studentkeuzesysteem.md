...
![Het koppelvlak van het studentkeuzesysteem](../src/koppelvlak_sks_view_ihp_v1_7.png)

De view toont het koppelvlak van het studentkeuzesysteem als optelsom van zijn koppelingen op de informatiestromen-hoofdplaat v1.7.
